  ...
  <div class="container px-6 mx-auto">
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="text-sm text-blue-600">
        Total Pengaduan: <span class="font-bold">{{ count($items) }}</span>
      </div>
    </div>
            ...
            <tr class="text-blue-900 hover:bg-blue-50 transition-colors duration-150">
              <td class="px-6 py-4">
                <div class="flex items-center">
                  <div class="relative">
                    <img class="w-20 h-20 object-cover rounded-lg shadow-sm border border-blue-100" src="{{ Storage::url($item->image) }}" alt="Bukti Pengaduan" loading="lazy" />
              ...
              <td class="px-6 py-4 text-sm">
                ...
                <div class="text-blue-500">{{ $item->created_at->format('H:i') }}</div>
              </td>
              <td class="px-6 py-4 text-sm">
