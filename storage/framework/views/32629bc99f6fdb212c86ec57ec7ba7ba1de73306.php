      ...
      <div class="bg-white form-container p-6">
        <div class="mb-6">
          ...
          <textarea
            ...
            class="w-full p-4 text-base border-2 border-blue-100 rounded-lg shadow-sm textarea-focus focus:outline-none focus:ring-1 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:placeholder-gray-400"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.masyarakat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\62822\Documents\LARAFEL PROJEK\pengaduan-masyarakat\resources\views/pages/masyarakat/index.blade.php ENDPATH**/ ?>